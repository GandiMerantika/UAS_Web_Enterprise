...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/stylehubungiKami.css') }}">
...
<body>
    ...
    <div class="container-news">
        <div class="container my-5">
            ...
            <form id="contactForm" class="row g-3" method="POST" action="{{ route('hubungiKami.store') }}">
                @csrf
                <!-- Nama -->
                <div class="col-md-6">
    ...
    <script>
        document.getElementById('contactForm').addEventListener('submit', function(event) {
            ...
            fetch('{{ route('hubungiKami.store') }}', {
                ...
                .then(data => {
                    alert(data.message);
                    window.location.href = '{{ route('home') }}'; // Pindah ke halaman Home
                })
                .catch(error => {
