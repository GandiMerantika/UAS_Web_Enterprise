...
<body>
    ...
    <header class="navbar navbar-expand-lg navbar-dark bg-gradient-custom shadow-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand text-white d-flex align-items-center" href="#">
                <img src="<?php echo e(asset('images/inaklug.png')); ?>" alt="Inaklug Logo" class="d-inline-block align-text-top"
                    height="50">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <!-- Button Daftar -->
                <a href="#" class="btn rounded-5 ms-auto text-white " style="background: #2d5086">Daftar
                    Online</a>
            </div>
        </div>
    </header>
    ...
    <main>
        ...
        <div class="w-100 mt-5 position-relative" style="height: 450px;">
            <img src="<?php echo e(asset('images/artikelpage.jpg')); ?>" alt="" class="w-100 h-100"
                style="object-fit: cover;">

            <div class="position-absolute top-0 left-0 h-100"
                style="width: 50%; background: linear-gradient(to right, #46074E, transparent); opacity: 0.8; border-radius: 10px 0 0 10px;">
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="card border-0">
                            <img src="<?php echo e(asset('images/tupai.png')); ?>" alt="Image 1" class="card-img-top rounded"
                    ...
                    <div class="col-md-6">
                        <div class="card border-0">
                            <img src="<?php echo e(asset('images/becak.png')); ?>" alt="Image 2" class="card-img-top rounded"
                                style="object-fit: cover; height: 250px;">
                            <div class="card-body p-2">
                                <p class="card-text text-center fw-bold">
                                    Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri dengan Beasiswa
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <div class="card">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="<?php echo e(asset('images/artikel1.jpg')); ?>" class="card-img" alt="Image 1">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri
                                            dengan Beasiswa</h5>
                                        <p class="card-text"><small class="text-muted">Selasa, 18 Feb 2020 12:01
                                                WIB</small></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 mb-3">
                        <div class="card">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="<?php echo e(asset('images/artikel2.jpg')); ?>" class="card-img" alt="Image 2">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri
                    ...
                    <div class="col-12 mb-3">
                        <div class="card">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="<?php echo e(asset('images/artikel3.jpg')); ?>" class="card-img" alt="Image 3">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri
                    ...
                    <div class="col-12 mb-3">
                        <div class="card">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="<?php echo e(asset('images/artikel4.jpg')); ?>" class="card-img" alt="Image 4">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri
                    ...
                    <div class="col-12 mb-3">
                        <div class="card">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="<?php echo e(asset('images/chinatown.png')); ?>" class="card-img" alt="Image 5">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri
...
<?php /**PATH C:\Users\rafli\Tugas_WebEnterprise\resources\views/test.blade.php ENDPATH**/ ?>