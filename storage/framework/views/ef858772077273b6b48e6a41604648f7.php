...
<nav class="navbar custom-navbar navbar-expand-lg">
    ...
    <div class="container custom-container">
        <a class="navbar-brand text-white" href="<?php echo e(route('home')); ?>">
            <img src="<?php echo e(asset('assets/img/Inaklug.png')); ?>" height="70" alt="">
            Inaklug
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(route('tentangKami')); ?>">TENTANG KAMI</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="">LAYANAN KAMI</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(route('artikel')); ?>">ARTIKEL</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(route('hubungiKami')); ?>">HUBUNGI KAMI</a>
                </li>
            </ul>
...
<?php /**PATH C:\Users\rafli\UAS_WEB2\resources\views/partials/navbar.blade.php ENDPATH**/ ?>